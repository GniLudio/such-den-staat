...
export interface components {
    schemas: {
        ...
        IconRef: string;
        /** @enum {string} */
        DisplayType: "ROADWORKS" | "WEBCAM" | "PARKING" | "WARNING" | "WEIGHT_LIMIT_35" | "CLOSURE" | "CLOSURE_ENTRY_EXIT" | "STRONG_ELECTRIC_CHARGING_STATION";
        /** @example {
...
export interface operations {
    ...
    "get-roadwork": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                roadworkId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    "get-webcam": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                webcamId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    "get-parking-lorry": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                lorryId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    "get-warning": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                warningId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    "get-closure": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                closureId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    "get-charging-station": {
        parameters: {
            ...
            path: {
                roadId: components["schemas"]["RoadId"];
                stationId: components["schemas"]["Identifier"];
            };
            cookie?: never;
        };
        requestBody?: never;
